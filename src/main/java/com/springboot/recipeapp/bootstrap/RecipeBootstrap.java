...
import com.springboot.recipeapp.domain.DifficultyEnum;
...
import com.springboot.recipeapp.repositories.CategoryCrudRepository;
import com.springboot.recipeapp.repositories.RecipeCrudRepository;
import com.springboot.recipeapp.repositories.UnitOfMeasureCrudRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private final UnitOfMeasureCrudRepository unitOfMeasureRepository;

    public RecipeBootstrap(CategoryCrudRepository categoryRepository, RecipeCrudRepository recipeRepository, UnitOfMeasureCrudRepository unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setDifficulty(DifficultyEnum.MEDIUM);
